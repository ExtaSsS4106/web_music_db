...
│   ├── 03_functions.sql        # Пользовательские функции
│   ├── 04_procedures.sql       # Хранимые процедуры
│   ├── 05_views.sql            # Представления
│   ├── 06_queries.sql          # Типовые запросы (5 шт.)
│   ├── 07_data.sql             # Тестовые данные
│   └── 08_deploy_all.sql       # Главный скрипт развертывания
│
├── docs/
│   ├── ER-diagram.md           # ER-диаграмма
│   └── course-work.docx        # Пояснительная записка
│
├── .gitignore
├── LICENSE
└── README.md
